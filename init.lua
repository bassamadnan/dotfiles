...
vim.keymap.set('n', 'X', 'd', { desc = 'cut like functionality' })
vim.keymap.set('n', 'd', '"_d', { desc = 'delete without putting into clipboard' })
vim.keymap.set('n', 'x', '"_x', { desc = 'delete char without putting into clipboard' })
-- Diagnostic keymaps
...
vim.opt.guicursor = 'n-v-c-sm:block-blinkon1,i-ci-ve:ver25-blinkon1,r-cr-o:hor20-blinkon1'
-- Set up formatters (you'll need to ensure null-ls is configured in your setup)
local null_ls = require 'null-ls'
null_ls.setup {
  sources = {
    null_ls.builtins.formatting.prettier.with {
